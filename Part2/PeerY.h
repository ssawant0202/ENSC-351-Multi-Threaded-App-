...
#define REST_BLK_SZ_CRC  (CHUNK_SZ + REST_BLK_OH_CRC) //128+2+2  = 132
#define BLK_SZ_CRC  	 (SOH_OH + REST_BLK_SZ_CRC) //1+128+1+2 =132 //1+128 +2+2 = 133
#define MOST_BLK_SZ_CRC	 (BLK_SZ_CRC - 1)// 133 - 1 = 132
